...
...button-text text="📋 复制" event="copy{繁星纵变，智慧永恒。}"
...row-end
...column-end
...card-end
...
...row-end
...row-start horizontal=spacedBy(8)
...button-filled-tonal text="📖 Minecraft Wiki" event="url{https://minecraft.wiki/Data_component_format%2Frepairable}" weight=(1)
...
📖 **Wiki 推荐**：[Data component format/repairable](https://minecraft.wiki/Data_component_format%2Frepairable)

⏰ 更新时间：2026-07-11 06:21:12
