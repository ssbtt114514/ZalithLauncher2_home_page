...
...button-text text="📋 复制" event="copy{我们所爱之物昭示着我们究竟是谁。}"
...row-end
...column-end
...card-end
...
...row-end
...row-start horizontal=spacedBy(8)
...button-filled-tonal text="📖 Minecraft Wiki" event="url{https://minecraft.wiki/Java_Edition_block_render_history%2FStripped_Warped_Stem}" weight=(1)
...
📖 **Wiki 推荐**：[Java Edition block render history/Stripped Warped Stem](https://minecraft.wiki/Java_Edition_block_render_history%2FStripped_Warped_Stem)

⏰ 更新时间：2026-05-16 07:30:22
